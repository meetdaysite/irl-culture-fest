...
export default function PartnerTeam() {
  ...
  return (
    <section
      ...
      style={{ paddingTop: 96, paddingBottom: 156 }}
    >
      ...
      >
        ...
        <p className="font-body text-[#555] text-base sm:text-lg mb-8 max-w-3xl">
          A team that has been curating experiences for 20+ years with 100+ global brands.
        </p>
      ...
      {/* Torn Paper Divider → next section: PartnerForm #FF2B2B */}
      <svg
