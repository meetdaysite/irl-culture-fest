...
export default function ManifestoSection() {
  ...
  return (
    ...
    >
      ...
      <DecorativeStar size={80} color="#1A1A1A" opacity={0.05} top="30%" left="2%" rotate={20} />
      <DecorativeStar size={120} color="#FF2B2B" opacity={0.07} bottom="10%" right="3%" spin spinDuration={40} />
      <DecorativeStar size={50} color="#1A1A1A" opacity={0.04} bottom="25%" left="8%" rotate={45} />
      <div
      ...
      >
        ...
        <motion.h2
          ...
          className="font-display text-[#1A1A1A] tracking-tight leading-none mb-12"
          style={{
            fontSize: "clamp(32px, 4.5vw, 56px)",
            letterSpacing: "0.01em",
          }}
        >
          The Problem: <span className="text-[#FF2B2B]">Great Culture</span>, <br></br>Fragile Business.
        </motion.h2>

        {/* Left-Right Column Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          {/* Left Column: Stacked Manifesto Cards */}
              ...
              return (
                <motion.div
                  ...
                  style={{
                    background: card.bg,
                    color: card.text,
                    border: card.bg === "#1A1A1A" ? "1px solid #333" : "none",
                    boxShadow: isHovered
          ...
          {/* Right Column: Two Larger, Stacked Angled Manifesto Images */}
          <div className="lg:col-span-6 flex flex-col gap-8 items-center justify-start w-full py-4">
            <motion.div
              ...
              className="relative overflow-hidden rounded-2xl border-2 border-[#F5F0E8] bg-[#1A1A1A] shadow-[4px_4px_0px_#FF2B2B] aspect-[4/3] w-[300px] sm:w-[360px] lg:-translate-x-8 cursor-pointer"
            >
              <img
            ...
            <motion.div
              ...
              className="relative overflow-hidden rounded-2xl border-2 border-[#F5F0E8] bg-[#1A1A1A] shadow-[4px_4px_0px_#f2af29] aspect-[4/3] w-[300px] sm:w-[360px] lg:translate-x-8 cursor-pointer"
            >
              <img
      ...
      {/* Torn Paper Divider → next section: SolutionSection #0D0D0D */}
      <svg
