...
const statsData = [
  { target: 4, suffix: "", label: "Cities", isNumeric: true },
  { target: 150, suffix: "+", label: "Community Builders", isNumeric: true },
  { target: 4, suffix: "", label: "Subculture Zones", isNumeric: true },
  { target: 1, suffix: "", label: "Movement", isNumeric: true },
  { text: "Nov 2026", suffix: "", label: "Save the Date", isNumeric: false },
];
